...
public class Budget {
    ...
    public Budget(Long id, User user, Category category,
                  BigDecimal limitAmount, Integer month, Integer year) {
        this.id = id;
        this.user = user;
    ...
    public static class BudgetBuilder {
        ...
        public BudgetBuilder limitAmount(BigDecimal limitAmount) {
            this.limitAmount = limitAmount;
            return this;
        }
        ...
        public Budget build() {
            return new Budget(id, user, category, limitAmount, month, year);
        }
    }
